...
class UserValidator
{
    ...
    {
        if(!$identifier) throw new InvalidIdentifierException("L'identifiant doit être renseigné");
    ...
    {
        if(!$email) throw new InvalidEmailException("L'email doit être renseigné");
    ...
    {
        if(!$password) throw new InvalidPasswordDomainException("Le password doit être renseigné");
